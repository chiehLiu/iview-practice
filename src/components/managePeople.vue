<template>
    <div style="margin:20px">
        ...
        <Checkbox-group v-model="tableColumnsChecked" @on-change="changeTableColumns" style="margin:10px ;boreder:1px solid #eeeeee">
    ...
    export default {
        data () {
            return {
                ...
                tableColumns2: [],
                tableColumnsChecked: ['show', 'weak', 'signin','active', 'day7', 'day30', 'tomorrow', 'day', 'week', 'month']
            }
        },
        methods: {
            mockTableData2 () {
